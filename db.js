...
firebase.auth().onAuthStateChanged(function(user) {
  if(user) {
     document.getElementById("navbar-username").innerHTML = "<div class='dropdown' style='float: right'><a class='toggle-dropdown'>" + user.email.replace("@fakeemail.com", "") + "</a><ul style='right: 0px; color: gray; max-height: 100px; margin: 20px 10px;'><li onclick='window.location.href = \"?edit\"'><i class='fas fa-feather'</i> Make a New Story</li><li onclick='signout()'><i class='as fa-door-open'</i> Logout</li></ul>";  
  } else {
