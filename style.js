...
setInterval(function() {
	if(document.getElementById("save-story-btn").getElementsByClassName("fa-spinner")[0]) {
		document.getElementById("save-story-btn").getElementsByClassName("fa-spinner")[0].style.transform = "rotate(" + ((document.getElementById("save-story-btn").getElementsByClassName("fa-spinner")[0].style.transform == "") ? "0" : (parseInt(document.getElementById("save-story-btn").getElementsByClassName("fa-spinner")[0].style.transform.substr(7).split("d")[0]) + 1)) + "deg)";
	} else {
